...
/**
 * This class provides the annotation neccessary to be used by any class extending {@link Controller}.
 * 
 * It records the following information:
 * <ol>
 *  <li>The path to FXML File</li>
 *  <li>The initialization method, defaults to {@link Initialization.Single_On_Demand}</li>
 *  <li>The name of the extra css containg custom styling, defaults to null</li>
 *  <li>The name of the icon of the stage of the controller, defaults to null</li>
 * </ol>
 * 
...
public @interface ControllerInfo{
    ...
    /**
     * The method of initialization of the controller, defaults to {@link Initialization.Single_On_Demand} 
     */
